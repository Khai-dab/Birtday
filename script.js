...
// Data Kartu (akan diacak setiap kali permainan dimulai)
const kartuTemplate = [
    { id: 3, icon: '💖', pesan: 'harta karun yang…' },
    { id: 5, icon: '💐', pesan: 'di hatiku…' },
    { id: 1, icon: '🎂', pesan: 'Setiap momen…' },
    { id: 6, icon: '🎉', pesan: 'selamanya.' },
    { id: 2, icon: '🌹', pesan: 'bersamamu adalah…' },
    { id: 4, icon: '🍫', pesan: 'tak ternilai…' },
    { id: 1, icon: '🎂', pesan: 'Setiap momen…' },
    { id: 3, icon: '💖', pesan: 'harta karun yang…' },
    { id: 5, icon: '💐', pesan: 'di hatiku…' },
    { id: 2, icon: '🌹', pesan: 'bersamamu adalah…' },
...
function selesaiGame(sukses) {
    ...
    if (sukses) {
        ...
        status.innerText = 'Momen-momenmu terlalu berharga untuk dilewatkan, coba lagi! 🌌';
...
function mulaiHal6() {
    ...
    const txtPesanAkhir = "<b>Selamat Ulang Tahun! 🥳</b> Yay.. Seseorang bertambah tua! 😆🤏, tapi jangan khawatir kamu hanya naik level! 😉<br><br>Semoga bab baru ini dipenuhi dengan kebahagiaan tanpa batas, kesehatan yang luar biasa, dan semoga semua doa tulus di hatimu dikabulkan. Aku berharap hari ini hanyalah awal dari tahun yang penuh dengan berkah indah, momen tak terlupakan, dan semua kebahagiaan yang kamu layak dapatkan";
    const txtLucu = "Dan semoga hari ini menjadi awal dari tahun yang penuh berkah dan kebahagiaan untukmu 💐<br><br><b><i>Teruslah bersinar! Dunia ini milikmu. 🚀<br><br><b><i>Semoga semua yang terbaik untukmu!</i> 🎉🥳</b>";
    const speedText = 20;
...
function balasWa() {
    ...
    const text = "Terima kasih untuk ucapan ulang tahunnya! ❤️";
